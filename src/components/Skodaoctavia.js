...
document.getElementById("submit").addEventListener("click", function(event) {
  ...
  return (
    <Container className='my-3'>
      <h1 className='p-2'>Skoda Octavia</h1>
      <Carousel data-bs-theme="light">
              <Carousel.Item>
                  <img
                      className="d-block w-100"
                      src={require("../components/imgtitle/S1.png")}
                      alt="First slide" />
              </Carousel.Item>
              <Carousel.Item>
                  <img
                      className="d-block w-100"
                      src={require('../components/imgtitle/s2.png')}
                      alt="Second slide" />
              </Carousel.Item>
              <Carousel.Item>
                  <img
                      className="d-block w-100"
                      src={require('../components/imgtitle/s3.png')}
                      alt="Third slide" />
              </Carousel.Item>
              <Carousel.Item>
                  <img
                      className="d-block w-100"
                      src={require('../components/imgtitle/s4.png')}
                      alt="Third slide" />
              </Carousel.Item>
          </Carousel>
          ...
          <div className='row'>
            ...
            <div className='col-md-8'>Skoda</div>
          </div>
          <div className='row'>
            <div className='col-md-4 fw-bold fs-5'>Модель</div>
            <div className='col-md-8'>Octavia</div>
          </div>
          <div className='row'>
            <div className='col-md-4 fw-bold  fs-5'>Двигатель</div>
            <div className='col-md-8'>бензин, 1.4, 1.6, 2.0 л </div>
          </div>
          <div className='row'>
            <div className='col-md-4 fw-bold  fs-5'>Мощность</div>
            <div className='col-md-8'>110, 150, 190 л.с.</div>
          </div>
          <div className='row'>
            <div className='col-md-4 fw-bold  fs-5'>Коробка передач</div>
            <div className='col-md-8'>АКПП, МКПП, робот, автомамт</div>
          </div>
          <div className='row'>
  ...
  <div id="comment" class="mt-2">
        <div class="card p-4">
          <div class="media">
            <img src='https://sun6-20.userapi.com/s/v1/ig1/5m-fx30S9InZ_MED5NdKNRKJiziFYykuHQKsaV1HCgSu5a-Xv4hZXEcsrKg-LOtV23g8vwFY.jpg?size=980x980&quality=96&crop=0,0,980,980&ava=1' class="mr-3 rounded" style={{height: "64px", width: "64px;"}}/>
              <div class="media-body">
                <h5 class="mt-1">Владислав Кукель</h5> 
                <div id="commentContent">
                В движении «Шкода Октавия А5» показывает себя как настоящий европейский автомобиль: управляемость отточенная, подвеска упругая, ход мягкий.

Передняя подвеска независимая, с поперечными рычагами треугольной формы, которые соединяются с кузовом пружиной и амортизатором (McPherson). Имеется стабилизатор поперечной устойчивости. Задняя подвеска независимая многорычажная, с пружинами, амортизаторами и стабилизатором поперечной устойчивости.

На трассовых скоростях машина легко управляется. Ее не нужно «ловить» на шоссе или подруливать, она отлично держит траекторию. «Октавия» отлично вписывается в повороты, крены кузова минимальные. Если вам нужно будет резко объехать внезапное препятствие, она позволит это сделать и вернуться на траекторию без последствий.

За то время, что я пользуюсь «Октавией», в подвеске ничего не ломалось. Но близится замена задних сайлентблоков передних рычагов, они стали постукивать на мелких неровностях. Новые стоят от 1 300 (неоригинал) до 2 800 рублей (оригинал), плюс — работа. 
                  </div>
              </div>
            </div>
          </div>
      ...
      <div id="comment" class="mt-2">
        <div class="card p-4">
          <div class="media">
            <img src='https://sun6-20.userapi.com/s/v1/ig1/5m-fx30S9InZ_MED5NdKNRKJiziFYykuHQKsaV1HCgSu5a-Xv4hZXEcsrKg-LOtV23g8vwFY.jpg?size=980x980&quality=96&crop=0,0,980,980&ava=1' class="mr-3 rounded" style={{height: "64px", width: "64px;"}}/>
              <div class="media-body">
                <h5 class="mt-1">dtat</h5> 
                <div id="commentContent">
                Это идеальный городской автомобиль с весьма хорошим оснащением и шумоизоляцией. Фары шикарно светят, ассистент парковки реально помогает, в машине куча ящичков для мелочей и ну нет у нее недостатков. Можно придираться по мелочи, но на ходовые - это никак не влияет.
                  </div>
              </div>
            </div>
          </div>
      ...
      <div id="comment" class="mt-2">
        <div class="card p-4">
          <div class="media">
            <img src='https://sun6-20.userapi.com/s/v1/ig1/5m-fx30S9InZ_MED5NdKNRKJiziFYykuHQKsaV1HCgSu5a-Xv4hZXEcsrKg-LOtV23g8vwFY.jpg?size=980x980&quality=96&crop=0,0,980,980&ava=1' class="mr-3 rounded" style={{height: "64px", width: "64px;"}}/>
              <div class="media-body">
                <h5 class="mt-1">Игорь</h5> 
                <div id="commentContent">
                Шкоду люблю еще с чешской фабии, в октавии приглянулся багажник и цена, правда немцы после того, как перекупили бренд сделали автомобили шкоды совсем пустые, а любая доп опции существенно прибавляет в цене. Расходники идут по накатанной, диски, колодки и т.п. Надо скоро менять, но вот на что...
              </div>
              </div>
            </div>
          </div>
